            ...
            <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="box p-5">
                            <ul class=" nav nav-pills w-4/5 bg-slate-100 dark:bg-black/20 rounded-md mx-auto " role="tablist">
                                <li id="active-users-tab" class="nav-item flex-1" role="presentation">
                                    <button class="nav-link w-full py-1.5 px-2 active" data-tw-toggle="pill" data-tw-target="#active-users" type="button" role="tab" aria-controls="active-users" aria-selected="true"> Tinjau Pesanan </button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane active" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                    ...
                                    <div class="w-52 sm:w-auto mx-auto mt-5">
                                        <div class="flex items-center">
                                            ...
                                            <span class="truncate">PESANAN BELUM DIBAYAR</span> <span class="font-medium ml-auto"><?= $pending; ?> Pesanan</span>
                                        </div>
                                        <div class="flex items-center mt-4">
                                            <div class="w-2 h-2 bg-success rounded-full mr-3"></div>
                                            <span class="truncate">PESANAN SUDAH TERBAYAR</span> <span class="font-medium ml-auto"><?= $sukses; ?> Pesanan</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-8 mt-2 lg:mt-6 xl:mt-2">
                    ...
                    <div class="mt-5">
                        ...
                        <?php endforeach; ?>
                        <a href="<?= site_url('admin/invoice') ?>" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-slate-400 dark:border-darkmode-300 text-slate-500">Tinjau Pesanan</a>
                    </div>
                </div>
                <!-- END: Users By Age -->
