  ...
  <div class="container sm:px-10">
    <div class="block xl:grid grid-cols-2 gap-4">
      ...
      <div class="hidden xl:flex flex-col min-h-screen">
        <a href="/app" class="-intro-x flex items-center pt-5">
          <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/images/logo.svg">
          <span class="text-white text-lg ml-3"> Keenan Jaya </span>
        </a>
        <div class="my-auto">
          ...
          <div class="-intro-x text-white font-medium text-2xl leading-tight mt-10">
            Whatsapp  : 0895412741121
            <br>
            Instagram : Keenan Jaya
          </div>
          <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Jika terdapat keluhan silahkan hubungi customer service <br>melalui Whatsapp dan Instagram</div>
        </div>
      </div>
      <!-- END: Login Info -->
      <!-- BEGIN: Login Form -->
